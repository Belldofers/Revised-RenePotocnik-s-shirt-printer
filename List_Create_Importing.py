...
def copy_to_recroom(img_data: list[str], delay: float = 0.03, last_successful_string: str or None = None,
    ...
    done_button: Coords = (int(SCREEN_DIMENSIONS[0] * 0.08-150), int(SCREEN_DIMENSIONS[1] * 0.45))  # New coordinates
    ...
    if ask_to_continue:
        ...
        print(f"This print will take up to {math.floor((num_strings*1.2)/60)} minutes {round((num_strings*1.2)-(math.floor((num_strings*1.1)/60)*60))} seconds")
